...
load_dir_as_json :: proc($T : typeid, directory_path : string, extension : string, include_extension : bool = false) -> (res : map[string]T) {
...
dir_exists :: proc(folder_path : string) -> (err: os.Errno) {
...
delete_dir :: proc(dir_path: string, loc := #caller_location) -> (success : bool) {
